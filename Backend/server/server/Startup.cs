...
namespace server
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            builder =>
            {
                builder.AllowAnyMethod().AllowAnyHeader()
                       .WithOrigins("https://localhost:3000", "http://localhost:3000", "http://localhost:8000")
                       .AllowCredentials();
            }));
            //
        ...
        public void Configure(IApplicationBuilder app, IWebHostEnvironment env)
        {
            ...
            //app.UseCors(options => options.WithOrigins("https://localhost:3006", "http://localhost:8000").AllowAnyHeader().AllowAnyMethod());
